...
if (NversioneAggiornata == version):
	...
	if vuoiAggiornare == "Si" or "si" or "yep" or "Yep" or "yes" or "Yes" or "y" or "Y":
		...
		time.sleep(3)
		os.system("python IPSWDownloader_" + NversioneAggiornata + ".py")
		time.sleep(4)
...
if deviceRichiesto == "iPhone 2G":
	...
	device = "iPhone8,4"
elif deviceRichiesto == "iPhone 7":
	print ("Quale modello di iPhone 7 intendi? Fra poco appariranno quelli disponibili:")
	velocizzaFunc(3)
	print "1) iPhone 7 (Nero opaco, Oro, Oro Rosa, Argento)"
	print "2) iPhone 7 Jet Black"
	mdliph7 = input("Scrivi il numero scritto a sinistra del modello che intendi: ")
	if mdliph7 == 1:
		device = "iPhone9,1"
	elif mdliph7 == 2:
		device = "iPhone9,3"
	...
	print "1) iPhone 7+ (Nero opaco, Oro, Oro Rosa, Argento)"
	print "2) iPhone 7+ Jet Black"
	mdliph7p = input("Scrivi il numero scritto a sinistra del modello che intendi: ")
	if mdliph7p == 1:
		device = "iPhone9,2"
	elif mdliph7p == 2:
		device = "iPhone9,4"
